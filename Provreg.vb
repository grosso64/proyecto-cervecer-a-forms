...
Public Class provreg
    ...
    Sub CargarCamposProveedores()
        ...
        da1.Fill(dsa, "proveedores")
        If dsa.Tables("proveedores").Rows.Count > 0 Then
            tAapellido.Text = dsa.Tables("proveedores").Rows(0)("apellido")
            ...
            tPostal.Text = dsa.Tables("Proveedores").Rows(0)("postal")
    ...
    Private Sub bAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bAceptar.Click
        ...
        End If
        If SQL_Accion("update proveedores set apellidoprov='" & tAapellido.Text.Trim.ToUpper.Replace("'", "´") & "', nombreprov='" & tNombre.Text.Trim.ToUpper.Replace("'", "´") & "', [Documento-prov]=" & Val(tDNI.Text.Trim.Replace(".", "").Replace(" ", "").Replace(",", "")) & ",domicilioprov='" & tDomicilio.Text.Trim.ToUpper.Replace("'", "´") & "', [localidadprov]='" & tLocalidad.Text.Trim.ToUpper.Replace("'", "´") & "', [provinciaprov]='" & tProvincia.Text.Trim.ToUpper.Replace("'", "´") & "', [postalprov]=' " & tPostal.Text.Trim.ToUpper.Replace("'", "´") & " ', [teléfonosprov]='" & tTelefono.Text.Trim.ToUpper.Replace("'", "´") & "', [e-mail-prov]='" & tMail.Text.Trim.ToUpper.Replace("'", "´") & "', usuario1='" & tUsuario1.Text.Trim.ToUpper.Replace("'", "´") & "',contrasenia1='" & tContrasenia1.Text.Trim.ToUpper.Replace("'", "´") & "' where nprov=" & VNum(lID2.Text)) = True Then
    ...
    Private Sub provreg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
