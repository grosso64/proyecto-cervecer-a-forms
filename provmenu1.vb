...
Public Class provmenu1
    ...
    Private Sub bAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bAceptar.Click
        ...
        Else
            ...
            MsgBox("Se produjo un error al querer guardar los datos del producto, reintente, y si el error persiste, anote todos los datos que quiso ingresar y comuníquese con el programador.")
        End If
    End Sub
    ...
    Private Sub bVolver_Click(sender As Object, e As EventArgs) Handles bVolver.Click
        ...
        Me.Close()
    End Sub
    Public Sub SetNombreproveedor(usuario As String)
